...
namespace ShieldDefender.Collisions
{
    public static class CollisionHelper
    {
        ...
        /// <returns>boolean if bounding circles collide</returns>
        ...
        /// <returns>true if the rectangles collide, false if they don't</returns>
        ...
        /// <returns>true if the bounds collide, false if they don't</returns>
